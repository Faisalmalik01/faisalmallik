...
export const projects = [
  ...
  id: 3,
  title: "Citefolio",
  description: "A client-side RAG document chat built with React and TypeScript, enabling users to upload PDFs and receive streaming AI responses with precise page-level citations. Features semantic chunking, fuzzy retrieval, and persistent chat history — deployed as static files with zero backend infrastructure.",
  categories: ["FRONTEND", "AI/ML"],
  tags: ["React", "TypeScript", "Tailwind CSS", "Zustand", "RAG", "Gemini API", "pdf.js"],
  image: "/projects/citefolio.png",
  link: "https://github.com/Faisalmalik01/citefolio",
  demo: "https://citefolio.vercel.app/",
  year: "2026",
  },
    {
    id: 4,
